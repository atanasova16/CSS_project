...
for (outfold in outfolds){
        ...
        x_train <- model.matrix(employment_rate ~ .-Region-labs_pca_hc4 - kmeans4, data = tr) #[,-c(16,29,30,31)]
        x_test <- model.matrix(employment_rate ~ .-Region-labs_pca_hc4 - kmeans4, data = ts) #[,-c(16,29,30,31)]
...
one_x <- model.matrix(employment_rate ~ .-Region-labs_pca_hc4 - kmeans4, data = scaled)[1,] #[1,-c(16,29,30,31)]
...
new_x_scaled_mm <- model.matrix(employment_rate ~ .-Region-labs_pca_hc4 - kmeans4, data = new_x_scaled) #[,-c(16,29,30,31)]
